function [temp,press,rho,Hgeopvector]=atmosphere_heister_metric(Hvector,GeometricFlag)
%ATMOSPHERE_HEISTER_METRIC Find atmospheric data using metric (meter)
%heights.
%
...
% Convert the output
temp = temp * conv.T.ranktokel;
press = press * conv.p.psftopa;
rho = rho * conv.rho.slugft3tokgm3;
Hgeopvector = Hgeopvector*conv.l.fttom;
